                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildSectionTitle(themeProvider, 'Contact Us'),
                          ...
                          // FAQs Section
                          _buildSectionTitle(themeProvider, 'Frequently Asked Questions'),
                          const SizedBox(height: 16),
                          _buildFAQItem(
                            themeProvider,
                          ...
                          // User Guides Section
                          _buildSectionTitle(themeProvider, 'User Guides'),
                          const SizedBox(height: 16),
                          _buildGuideItem(themeProvider, 'Getting Started with CurrenSee'),
                          _buildGuideItem(themeProvider, 'Understanding Currency Charts'),
                          _buildGuideItem(themeProvider, 'Managing Your Profile'),
                          const SizedBox(height: 32),
                        ],
                      ),
                    ),
